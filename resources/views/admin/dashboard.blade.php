<x-default>
    <div
        ...
        <!-- Navigations -->
        <nav class="col-span-1 bg-white flex flex-col items-center p-6 gap-14">
            <img src="{{ asset('images/main-logo.png') }}" class="w-30" alt="" />
            <!-- Logo -->

            <!-- Account Info -->
            <div class="flex flex-col gap-2 items-center">
                <img src="{{ asset('images/profile.jpg') }}" class="w-20 rounded-full" alt="" />
                <!-- Profile Pic -->
                <div class="flex flex-col items-center">
                    <p class="text-lg">
                        <span class="font-semibold leading-none">Landoy, </span>Elpie
                    </p>
                    <!-- Fullname -->
                    <small class="leading-none text-paragraph">Admin</small>
                    <!-- Specializzation -->
                </div>
            </div>
            ...
            <div class="w-full text-paragraph flex flex-col gap-2">
                <a
                    class="hover:bg-blue-button hover:text-white flex gap-2 active:bg-blue-button px-8 py-4 active:text-white rounded-xl active-nav shadow-blue-button shadow-xl/35">
